...
<br>
<div align="center" style="background: linear-gradient(to bottom, #2c5364, #0f2027); padding: 25px; border-radius: 20px; box-shadow: 0px 4px 10px rgba(0,0,0,0.5);">
  <h1 style="color: #00d2ff; font-family: 'Poppins', sans-serif; margin-bottom: 20px;"> ⚡GitHub Stats ⚡</h1>

  <!-- Streak Stats -->
  <img width="400" src="https://github-readme-streak-stats-salesp07.vercel.app/?user=SaiDivakar-Navara&count_private=true&theme=highcontrast&border_radius=15" alt="Streak Stats" style="margin: 15px; border: 2px solid #00d2ff; border-radius: 15px;" />
  
  <!-- Readme Stats -->
  <img width="400" src="https://github-readme-stats-salesp07.vercel.app/api?username=SaiDivakar-Navara&count_private=true&show_icons=true&theme=tokyonight&rank_icon=github&border_radius=15" alt="Readme Stats" style="margin: 15px; border: 2px solid #00d2ff; border-radius: 15px;" />
  
  <!-- Top Languages -->
  <img width="330" src="https://github-readme-stats-salesp07.vercel.app/api/top-langs/?username=SaiDivakar-Navara&hide=HTML&langs_count=8&layout=compact&theme=tokyonight&border_radius=15&size_weight=0.5&count_weight=0.5&exclude_repo=github-readme-stats" alt="Top Langs" style="margin: 15px; border: 2px solid #00d2ff; border-radius: 15px;" />
  
  <h2 style="color: #e0e0e0; font-family: 'Poppins', sans-serif; margin-top: 25px;">💡 Connect With Me 💡</h2>
  <p style="color: #b3b3b3; font-family: 'Poppins', sans-serif; font-size: 16px;">
    🛠️ Building Projects | 🌟 Sharing Knowledge | 🌐 Exploring the Tech World
  </p>
</div>
